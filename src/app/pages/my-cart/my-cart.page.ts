...
export class MyCartPage implements OnInit {
  ...
  async parametring2() {
    return new Promise((resolve, reject) => {
      this.paramService.getAppCost().subscribe((res: any) => {
        this.app_cost = res
        resolve(true)
      })
    })
  ...
  async parametring3() {
    return new Promise((resolve, reject) => {
      this.paramService.getPercent().subscribe({
        next: (res: any) => {
          this.percent = res;
          resolve(true);
        },
  ...
  async parametring5() {
    return new Promise((resolve, reject) => {
      this.orderService.delivery_type.subscribe((type) => {
        this.paramService.getDelivery({ type }).subscribe((res: any) => {
          this.delivery = res
          resolve(true)
        })
      })
  ...
  removeProductFromOrder(index: any) {
