    ...
    if (((!tel.startsWith('06') && !tel.startsWith('07')) || (tel.length !== 10)) || ((!whatsapp.startsWith('06') && !whatsapp.startsWith('07')) || (whatsapp.length !== 10))) {
      ...
      this.userService.register(data).subscribe((res: any) => {
        ...
        if (this.beingRegistred) {
          ...
          // let xxxccc = `=مرحبا%2C%20لقد%20تمت%20إضافتك%20إلى%0a%20لائحة%20${listname}%2C%20يمكنكم%20ولوج%20تطبيق%20رائد (RAIUD)%20بأدخال%20رقم%20هاتفكم%0a%20*${data.tel}*%20و%20رمزكم%20السري%20*${res.genPwd}*%20بعد%20تسجيلكم%20بهذا%20رمز%20يمكنكم%20تغييره%20برمز%20سري%20خاص%20بكم%0a%0a%0A%0A%0A.ملاحظه%3A%0A%20تطبيق%20إقتصد%20غير%20متاح%20لأن%20على%20متجر%20قوقل%20بلاي%20سيتم%20إصداره%20قريباً%20و%20سوف%20%20نخبركم%20فور%20نزوله.`
